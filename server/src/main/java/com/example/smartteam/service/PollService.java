...
import com.example.smartteam.payload.PollRequest;
import com.example.smartteam.payload.PollResponse;
import com.example.smartteam.payload.VoteRequest;
import com.example.smartteam.repository.PollRepository;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getPollsCreatedBy(String username, UserPrincipal currentUser, int page,
        ...
        // Retrieve all smartteam created by the given username
        Pageable pageable = PageRequest.of(page, size, Sort.Direction.DESC, "createdAt");
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        List<PollResponse> pollResponses = polls.stream()
                .map(poll -> ModelMapper.mapPollToPollResponse(poll, choiceVoteCountMap,
    ...
    public Poll createPoll(PollRequest pollRequest) {
        ...
        pollRequest.getChoices().forEach(choiceRequest -> {
            poll.addChoice(new Choice(choiceRequest.getText(), choiceRequest.getScore()));
        });
    ...
    Map<Long, User> getPollCreatorMap(List<Poll> polls) {
        // Get Poll Creator details of the given list of smartteam
