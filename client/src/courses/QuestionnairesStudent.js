...
import { Radio, Input, Slider, Icon, Divider, Rate } from "antd";
    ...
    return (
      <div>
        ...
        <div className="icon-wrapper">
          <p>
            How much would you like to be in a team? Sliding to the right
            indicates more likes.
          </p>
        ...
        <div>
          <span>
            ...
            />
            {rating_value ? (
              <span className="ant-rate-text">{desc[rating_value - 1]}</span>
            ) : (
              ""
            )}
          </span>
